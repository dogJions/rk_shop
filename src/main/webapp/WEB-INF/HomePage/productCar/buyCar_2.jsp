...
<script type="text/javascript"
	src="${ctx}/public/js/HomePageJs/productCar/buyCar_2.js"></script>
...
<body>
	...
	<div class="section">
		...
		<form action="${ctx}/car/add_shop_og" method="post">
			...
			<div class="buy-foot clearfix">
				...
				<div class="right-box">
					<p>
						商品 <label class="price">1</label> 件&nbsp;&nbsp;&nbsp;&nbsp; 商品金额：￥<label
							id="goodsAmount" class="price">====</label>
						元&nbsp;&nbsp;&nbsp;&nbsp;
					</p>
					<p class="txt-box">
						应付总金额：￥<label  class="price">
						<input name="totalMoney" type="text" id="totalAmount" value="">
						</label>
					</p>
					<p class="btn-box">
